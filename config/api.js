...
var WxApiRoot_mc = 'http://39.99.135.185:8080/';
...
module.exports = {
  ...
  CatalogList: WxApiRoot_mc + 'rest/outer/n/gc/f/list', //分类目录全部分类数据接口
  CatalogCurrent: WxApiRoot_mc + 'rest/outer/n/gd/list', //分类目录当前分类数据接口

  AuthLoginByWeixin: WxApiRoot + 'auth/login_by_weixin', //微信登录
  loginByWeChatPhone: WxApiRoot + 'auth/loginByWeChatPhone', // 微信手机号登录 新地址
  getSessionKeyByCode: WxApiRoot_mc + 'rest/outer/wx/c/auth', // getSessionKeyByCode
  ...
  GoodsList: WxApiRoot_mc + 'rest/outer/n/gd/list', //获得商品列表
